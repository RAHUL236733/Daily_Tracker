  ...
  return (
    <aside className="hidden md:flex w-64 shrink-0 flex-col border-r border-sidebar-border bg-sidebar">
      ...
      <nav className="flex-1 px-3 py-5 space-y-1">
        <p className="px-3 pb-2 text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Workspace</p>
        {items.map((item) => {
      ...
      <div className="m-3 rounded-2xl bg-gradient-to-br from-primary to-[oklch(0.65_0.18_290)] p-4 text-primary-foreground shadow-elevated">
        ...
        <p className="mt-1 text-sm font-semibold leading-snug">Small habits compound into remarkable results.</p>
      </div>
    </aside>
  );
}
